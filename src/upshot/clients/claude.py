...
Format:
- Start with a "## TL;DR" section: 5-8 bullet points, each ONE sentence max, covering the single most important fact from each major story. Every TL;DR bullet MUST include at least one source link in markdown format: "([source label](URL))".
